...
from greedyfhist.options import GreedyOptions, AffineGreedyOptions, NonrigidGreedyOptions
...
def affine_registration2(path_to_greedy: str,
                        path_to_fixed_image: str,
                        path_to_moving_image: str,
                        path_output: str,
                        offset:int,
...
def deformable_registration2(path_to_greedy:str,
                            path_fixed_image:str,
                            path_moving_image:str,
